"""
Django settings for samueltest_app_2 project.
...
ROOT_URLCONF = 'samueltest_app_2.urls'
...
WSGI_APPLICATION = 'samueltest_app_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "SamuelTest-App Support <support@samueltest-app-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samueltest_app_2 API",
    "DESCRIPTION": "API documentation for samueltest_app_2 App",
    "VERSION": "v1",
}
